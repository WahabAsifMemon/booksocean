				...
				<div class="mega-dropdown-wrapper">
					...
					<div class="navigation">
						<ul>
							...
							<li class=""><a href="/about"><i class="fa fa-files-o"></i>About</a></li>
							<li class=""><a href="/gallery"><i class="fa fa-files-o"></i>gallery</a></li>
							<li class=""><a href="/author"><i class="fa fa-file-text"></i>author</a></li>
							<li class=""><a href="/contact"><i class="fa fa-fax"></i>contact</a></li>
						</ul>
					</div>				
					<!-- Navigation -->
				</div>
