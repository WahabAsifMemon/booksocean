							...
							<div class="book-list-widget masonry-grid business">
								...
								<div class="book-list-detail">
									@if($book->book_img == 'No image found')
                                        <img src="/assets/images/no-image.png" width="109" height="164" alt="No image found">
                                    @else
									...
									<div class="detail">
										...
										<div class="book-name">
											<h5>{{ $book->title }} <span></span></h5><strong>Rs/ {{ number_format($book->price)  }}</strong>
										</div>
								...
								<div class="book-list-btm">
									<div class="like-nd-share">
										<ul>
											<li><a href="{{ route('book.detail', ['slug' => $book->slug]) }}"><i class="fa fa-eye"></i>View</a></li>
										</ul>
									</div>
								</div>
							</div>
