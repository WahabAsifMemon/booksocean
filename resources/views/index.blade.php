...
<main class="main-content">
		...
		<div class="item">
			@if($slider->media_img == 'No image found')
      			<img src="assets/images/no-image.png" width="1349" height="516" alt="No image found">
      		@else
			    				...
			    				<div class="product-box">
			    					<div class="product-img">
			    						@if($downloaded_book->book_img == 'No image found')
											<img src="/assets/images/no-image.png" width="132" height="197" alt="No image found">
										@else
			    					...
			    					<div class="product-detail">
			    						...
			    						<h5><a href="#">{{ $downloaded_book->title }}</a></h5>
				...
				<div class="recomend-slider">
					...
					<div class="item">
						@if($recomended_book->book_img == 'No image found')
							<img src="/assets/images/no-image.png" width="109" height="150" alt="No image found">
						@else
							<img src="/uploads/{{ $recomended_book->book_img }}" width="109" height="150"  alt="{{ $recomended_book->title }}">
						@endif
					</div>
					<!-- Item -->
					@empty
							...
							<div class="sidebar">
								...
								<ul>
									@forelse($categories as $category)
										<li><a href="{{ route('category.detail', ['slug' => $category->slug]) }}">{{ $category->title }}</a></li>
									@empty
										<div class="alert alert-danger">No record found!</div>
									@endforelse									
								</ul>
											...
											<div class="s-product">
												<div class="s-product-img">
													@if($book->book_img == 'No image found')
														<img src="/assets/images/no-image.png" width="145" height="209" alt="No image found">
													@else
														<img src="/uploads/{{ $book->book_img }}" width="145" height="209" alt="{{ $book->title }}">
													@endif									
													<div class="s-product-hover"></div>
												</div>
												<h6><a href="#">{{ Str::limit($book->title, 15, '...') }}</a></h6>
					...
					<div class="col-lg-3 col-sm-12">
						<div class="aurthor-img">
							@if($author_feature->author_img == 'No image found')
								<img src="/assets/images/no-image.png" width="243" height="344" alt="No image found">
							@else
			                ...
			                <li>
			                  	<div class="gallery-figure">
			                  		@if($gallery->media_img == 'No image found')
										<img src="/assets/images/no-image.png" width="242" height="187" alt="No image found">
									@else
