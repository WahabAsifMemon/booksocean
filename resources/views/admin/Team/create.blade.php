                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="form-group @error('facebook id') has-error @enderror">
                                ...
                                <div class="form-group @error('twitter id') has-error @enderror">
                                ...
                                <div class="form-group @error('pinterest id') has-error @enderror">
